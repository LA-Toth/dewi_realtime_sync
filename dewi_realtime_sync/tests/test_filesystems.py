...
from dewi_realtime_sync.filesystem import RemoteFilesystem, LocalFilesystem


class RemoteFilesystemTest(dewi_core.testcase.TestCase):
    def set_up(self):
...
class LocalFilesystemTest(dewi_core.testcase.TestCase):
    def set_up(self):
